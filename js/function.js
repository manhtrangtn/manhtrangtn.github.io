...
function converter_length(){
	...
	if (from == 'inch') {
		...
		if (to == 'inch') {
			...
			res = input*1; formula.innerText = ""; //m to m
			x= des.meters;
		}
		output.value= res;
	...
	if (from == 'feet') {
		if (to == 'inch') {
			...
			res = input*1; formula.innerText = ""; //ft to ft
			x= des.feet;
		}
		output.value= res;
	...
	if (from == "yard") {
		if (to == 'inch') {
			...
			res = input*1; formula.innerText = ""; //yd to yd
			x= des.yard;
		}
		output.value= res;
	...
	if (from == 'kilometers') {
		if (to == 'inch') {
			...
			res = input*1; formula.innerText = ""; //km to km
			x= des.kilometers;
		}
		output.value= res;
	...
	if (from == 'millimeters') {
		if (to == 'inch') {
			...
			res = input*1; formula.innerText = ""; //mm to mm
			x= des.millimeters;
		}
		output.value= res;
	...
	if (from == "miles") {
		if (to == 'inch') {
			...
			res = input*1; formula.innerText = ""; //mile to mile
			x= des.miles;
		}
		output.value= res;
	...
	if (from == 'centimeters') {
		if (to == 'inch') {
			...
			res = input*1; formula.innerText = ""; //cm to cm
			x= des.centimeters;
		}
		output.value= res;
...
function converter_volume() {
	...
	if (from == 'fluid ounces') {
		...
		res_unit.innerText=to;document.getElementById('vol-from-unit-label').innerText = from;
